...
const mockMessages: Message[] = [
  {
    id: '1',
    sender: 'them',
    content: 'Hello, I wanted to discuss the latest updates on my employment case.',
    timestamp: '10:15 AM'
  },
  {
    id: '2',
    sender: 'me',
    content: 'Of course! I have good news. We received a favorable response from the opposing counsel.',
    timestamp: '10:18 AM'
  },
  {
    id: '3',
  ...
  },
  {
    id: '4',
    sender: 'me',
    content: 'I\'ve prepared a detailed summary of the settlement offer. Let me send you the document.',
    timestamp: '10:25 AM',
  ...
  },
  {
    id: '5',
    sender: 'them',
    content: 'Thank you for the update on my case. I\'ll review the document and get back to you.',
    timestamp: '10:30 AM'
  }
];
                    ...
                    <div className="relative">
                      <Avatar>
                        <AvatarFallback className={`${
                          contact.role === 'lawyer' ? 'bg-[#1E3A8A]' : 'bg-[#D4AF37]'
                        } text-white`}>
                          {contact.avatar}
                        </AvatarFallback>
                      </Avatar>
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                  <div className="relative">
                    <Avatar>
                      <AvatarFallback className={`${
                        selectedContact.role === 'lawyer' ? 'bg-[#1E3A8A]' : 'bg-[#D4AF37]'
                      } text-white`}>
                  ...
                  <div>
                    <h3 className="text-[#1E293B]">{selectedContact.name}</h3>
